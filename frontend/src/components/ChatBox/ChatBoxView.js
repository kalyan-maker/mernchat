    ...
    <div className="container-fluid animate__animated animate__wobble py-5">
      <div className="container">
        ...
        <p className=" text-center">
          Team created by @{props.team.user.username}
        </p>
        <div className="messaging">
          <div className="inbox_msg">
            <div className="inbox_people">
              ...
              <div className="inbox_chat">{team_user_list}</div>
            </div>
            <div className="mesgs">
              <div className="msg_history">{chatMessages}</div>
              <div className="type_msg">
                <div className="input_msg_write">
                  ...
                  <button
                    ...
                    type="button"
                  >
                    <i className="far fa-comment-dots text-warning"></i>
                  </button>
                </div>
              </div>
            </div>
